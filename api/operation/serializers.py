...
class ProjectUpdateSerializer(serializers.ModelSerializer):
    ...
    def validate_to_be_started(self, project, update_date, total_man_days, total_achievement, status, user_role):
        ...
        interview_sample_size = int(project.sample)
...
class OperationTeamSerializer(serializers.ModelSerializer):
    class Meta:
        model = ProjectUpdate
        fields = ['id', 'project_id', 'updated_by', 'update_date', 'total_man_days', 'total_achievement', 'remaining_time', 'remaining_interview', 'is_active']
        read_only_fields = ['id']
